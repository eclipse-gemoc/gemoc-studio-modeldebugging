 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.executionframework.value.model.value.impl.IntegerObjectAttributeValueImpl#getAttributeValue <em>Attribute Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerObjectAttributeValueImpl extends AttributeValueImpl implements IntegerObjectAttributeValue {
	/**
	...
	protected EClass eStaticClass() {
		return ValuePackage.Literals.INTEGER_OBJECT_ATTRIBUTE_VALUE;
	}
	...
	public void setAttributeValue(Integer newAttributeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.INTEGER_OBJECT_ATTRIBUTE_VALUE__ATTRIBUTE_VALUE, oldAttributeValue, attributeValue));
	}
