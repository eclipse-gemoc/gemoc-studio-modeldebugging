 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.executionframework.value.model.value.impl.StringAttributeValueImpl#getAttributeValue <em>Attribute Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringAttributeValueImpl extends AttributeValueImpl implements StringAttributeValue {
	...
	protected EClass eStaticClass() {
		return ValuePackage.Literals.STRING_ATTRIBUTE_VALUE;
	}
	...
	public void setAttributeValue(String newAttributeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.STRING_ATTRIBUTE_VALUE__ATTRIBUTE_VALUE, oldAttributeValue, attributeValue));
	}
