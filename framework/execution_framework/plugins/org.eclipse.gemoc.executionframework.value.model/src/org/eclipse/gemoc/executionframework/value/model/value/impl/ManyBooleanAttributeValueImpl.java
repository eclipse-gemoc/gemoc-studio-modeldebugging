 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.executionframework.value.model.value.impl.ManyBooleanAttributeValueImpl#getAttributeValue <em>Attribute Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ManyBooleanAttributeValueImpl extends AttributeValueImpl implements ManyBooleanAttributeValue {
	/**
	...
	protected EClass eStaticClass() {
		return ValuePackage.Literals.MANY_BOOLEAN_ATTRIBUTE_VALUE;
	}
	...
	public EList<Boolean> getAttributeValue() {
		if (attributeValue == null) {
			attributeValue = new EDataTypeUniqueEList<Boolean>(Boolean.class, this, ValuePackage.MANY_BOOLEAN_ATTRIBUTE_VALUE__ATTRIBUTE_VALUE);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuePackage.MANY_BOOLEAN_ATTRIBUTE_VALUE__ATTRIBUTE_VALUE:
