...
public class EngineAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected EngineSwitch<Adapter> modelSwitch = new EngineSwitch<Adapter>() {
		@Override
		public Adapter caseEObjectEListEObject(EObjectEListEObject object) {
			return createEObjectEListEObjectAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.gemoc.executionframework.engine.model.engine.EObjectEListEObject <em>EObject EList EObject</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.gemoc.executionframework.engine.model.engine.ResourceEObject <em>Resource EObject</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
