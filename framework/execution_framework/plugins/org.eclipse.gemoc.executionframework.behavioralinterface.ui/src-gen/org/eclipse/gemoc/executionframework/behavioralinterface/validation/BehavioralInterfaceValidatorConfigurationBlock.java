...
public class BehavioralInterfaceValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(BehavioralInterfaceConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("BehavioralInterface");
		if (section == null) {
			return dialogSettings.addNewSection("BehavioralInterface");
		}
		return section;
	}
}
