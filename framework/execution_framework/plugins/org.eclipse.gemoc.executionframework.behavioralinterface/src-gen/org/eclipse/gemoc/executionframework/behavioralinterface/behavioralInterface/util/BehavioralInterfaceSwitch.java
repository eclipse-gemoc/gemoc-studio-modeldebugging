...
public class BehavioralInterfaceSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        BehavioralInterface behavioralInterface = (BehavioralInterface)theEObject;
        T result = caseBehavioralInterface(behavioralInterface);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Behavioral Interface</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Behavioral Interface</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseBehavioralInterface(BehavioralInterface object)
  {
    return null;
  }
