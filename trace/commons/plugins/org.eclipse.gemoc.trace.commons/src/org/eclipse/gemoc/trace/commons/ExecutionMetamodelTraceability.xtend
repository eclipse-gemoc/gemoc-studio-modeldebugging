...
abstract class ExecutionMetamodelTraceability {
	...
	static def void createTraceabilityAnnotation(EModelElement elementToAnnotate, String traceabilityAnnotationValue) {
	...
	static def String getTraceabilityAnnotationValue(EModelElement annotatedElement) {
	...
	static def EAnnotation getTraceabilityAnnotation(EModelElement annotatedElement) {
