 ...
 * @generated
 */
public class SingleReferenceValueItemProvider extends GenericReferenceValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GenerictracePackage.Literals.SINGLE_REFERENCE_VALUE__REFERENCE_VALUE,
				 true,
				 false,
				 true,
				 null,
