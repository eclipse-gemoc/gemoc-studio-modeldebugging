...
import org.eclipse.gemoc.execution.sequential.javaxdsml.ide.ui.templates.SequentialNewLanguageTemplate;
...
public class CreateDSAProjectHandler extends AbstractMelangeSelectHandler implements IHandler  {
	...
	public Object executeForSelectedLanguage(ExecutionEvent event,
		...
		if(action.getLastCreatedProject() != null){
			...
			Set<String> aspects = SequentialNewLanguageTemplate.getAspectClassesList(action.getLastCreatedProject());
