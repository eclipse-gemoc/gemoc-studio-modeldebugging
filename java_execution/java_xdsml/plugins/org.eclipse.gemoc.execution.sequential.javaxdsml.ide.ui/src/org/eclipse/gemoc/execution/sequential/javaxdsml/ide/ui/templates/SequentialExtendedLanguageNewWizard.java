...
public class SequentialExtendedLanguageNewWizard extends NewProjectTemplateWizard{

	@Override
	public void init(BaseProjectWizardFields data) {
		super.init(data);
		setWindowTitle(WizardTemplateMessages.SequentialExtendedLanguageTemplate_wtitle);
		...
		try {
			...
			if(project.endsWith(SUFFIX)){
				...
				SequentialExtendedLanguageTemplate selection = (SequentialExtendedLanguageTemplate) selections[0];
	...
	public ITemplateSection[] createTemplateSections() {
		return new ITemplateSection[] {new SequentialExtendedLanguageTemplate()};
	}
}
